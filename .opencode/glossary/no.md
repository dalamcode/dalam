...
- PR #10018: https://github.com/dalamcode/dalam/pull/10018
- PR #12935: https://github.com/dalamcode/dalam/pull/12935

## Do Not Translate (Locale Additions)

- `Dalam` (preserve casing in prose; keep `dalam` only in commands, package names, paths, or code)
- `Dalam CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`

...
- PR #13942: https://github.com/dalamcode/dalam/pull/13942

## Do Not Translate (Locale Additions)

- `Dalam` (preserve casing in prose; keep `dalam` only when it is part of commands, package names, paths, or code)
- `Dalam Zen`
- `Dalam CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `dalam` in prose when referring to the product name; use `Dalam`

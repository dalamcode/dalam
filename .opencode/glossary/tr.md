...
- PR #15835: https://github.com/dalamcode/dalam/pull/15835

## Do Not Translate (Locale Additions)

- `Dalam` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `dalam` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Dalam` in prose, `dalam` only for exact technical identifiers
...
- Avoid changing `dalam` to `Dalam` inside commands, URLs, package names, or code literals

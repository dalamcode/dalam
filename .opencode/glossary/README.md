...
Use this folder for locale-specific translation guidance that supplements `.dalam/agent/translator.md`.
...
- PR #12345: https://github.com/dalamcode/dalam/pull/12345

## Do Not Translate (Locale Additions)

- `Dalam` (preserve casing)

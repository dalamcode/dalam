...
Desktop application and browser-based app issues, including `dalam web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core dalam server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Dalam Zen, Dalam Go, and billing issues.

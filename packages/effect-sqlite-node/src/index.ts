...
export const TypeId: TypeId = "~@uthakkan/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@uthakkan/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@uthakkan/effect-sqlite-node/NodeSqliteClient")

...
const samples = [
  {
    tool: "apply_patch",
    error:
      "apply_patch verification failed: Failed to find expected lines in /Users/davidhill/Documents/Local/dalam/packages/ui/src/components/session-turn.tsx",
  },
  {
    tool: "bash",
  ...
  },
  {
    tool: "read",
    error:
      "read File not found: /Users/davidhill/Documents/Local/dalam/packages/ui/src/components/does-not-exist.tsx",
  },
  {
    tool: "glob",

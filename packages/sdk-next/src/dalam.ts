import { Dalam } from "@uthakkan/client/effect"
...
import { createEmbeddedRoutes } from "@uthakkan/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Dalam.create")(function* () {
  ...
  const client = yield* Dalam.make({ baseUrl: "http://dalam.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@uthakkan/sdk-next/Dalam") {}

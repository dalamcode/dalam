...
- Effect plugins import `@uthakkan-dalam/plugin/v2/effect`, not `@uthakkan-dalam/core`.
- Public domain values use generated `@uthakkan-dalam/sdk` types.
...
- Define `PluginHost` domain capabilities in `@uthakkan-dalam/plugin/v2/effect`.

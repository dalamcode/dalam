...
import type { Definition } from "@uthakkan/schema/event"
...
export const DalamEvent = event.schema
export type DalamEvent = typeof DalamEvent.Type
export type DalamEventEncoded = typeof DalamEvent.Encoded

...
import { ProviderPlugins } from "@uthakkan/core/plugin/provider"
import { ZenmuxPlugin } from "@uthakkan/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://dalam.uthakkan.in/", "X-Title": "dalam" })

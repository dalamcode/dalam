...
import { AgentV2 } from "@uthakkan/core/agent"
import { ModelV2 } from "@uthakkan/core/model"
import { SessionV2 } from "@uthakkan/core/session"
import { Agent } from "@uthakkan/schema/agent"
import { Location } from "@uthakkan/schema/location"
import { Model } from "@uthakkan/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@uthakkan/schema/prompt"
import { Provider } from "@uthakkan/schema/provider"
import { Project } from "@uthakkan/schema/project"
import { ProjectDirectories } from "@uthakkan/schema/project-directories"
import { PermissionV1 } from "@uthakkan/schema/permission-v1"
import { Session } from "@uthakkan/schema/session"
import { SessionInput } from "@uthakkan/schema/session-input"
import { SessionMessage } from "@uthakkan/schema/session-message"
import { Workspace } from "@uthakkan/schema/workspace"
import { Command } from "@uthakkan/schema/command"
import { Connection } from "@uthakkan/schema/connection"
import { Credential } from "@uthakkan/schema/credential"
import { FileSystem } from "@uthakkan/schema/filesystem"
import { Integration } from "@uthakkan/schema/integration"
import { LLM } from "@uthakkan/schema/llm"
import { Permission } from "@uthakkan/schema/permission"
import { Plugin } from "@uthakkan/schema/plugin"
import { Pty } from "@uthakkan/schema/pty"
import { Reference } from "@uthakkan/schema/reference"
import { SessionTodo } from "@uthakkan/schema/session-todo"
import { Skill } from "@uthakkan/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@uthakkan/schema/schema"
import { ProviderV2 } from "@uthakkan/core/provider"
import { PluginV2 } from "@uthakkan/core/plugin"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@uthakkan/core/command"),
    import("@uthakkan/core/integration/connection"),
    import("@uthakkan/core/credential"),
    import("@uthakkan/core/filesystem"),
    import("@uthakkan/core/integration"),
    import("@uthakkan/core/location"),
    import("@uthakkan/llm"),
    import("@uthakkan/core/permission"),
    import("@uthakkan/core/v1/permission"),
    import("@uthakkan/core/project/copy"),
    import("@uthakkan/core/pty"),
    import("@uthakkan/core/project/schema"),
    import("@uthakkan/core/reference"),
    import("@uthakkan/core/session/input"),
    import("@uthakkan/core/session/message"),
    import("@uthakkan/core/session/todo"),
    import("@uthakkan/core/session/prompt"),
    import("@uthakkan/core/skill"),
    import("@uthakkan/core/v2-schema"),
    import("@uthakkan/core/schema"),
    import("@uthakkan/core/workspace"),
  ])

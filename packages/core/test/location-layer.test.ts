...
import { define } from "@uthakkan/plugin/v2/effect"
...
import { LocationServiceMap } from "@uthakkan/core/location-services"
      ...
      Effect.flatMap(([blocked, allowed]) =>
        Effect.gen(function* () {
          ...
          yield* Effect.promise(() =>
            fs.writeFile(
              path.join(blocked.path, "dalam.json"),
              JSON.stringify({

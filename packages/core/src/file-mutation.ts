...
export class Service extends Context.Service<Service, Interface>()("@dalam/v2/FileMutation") {}

/**
 * Serialize file changes by canonical target. Conditional writes compare and
 * write under the same process-local lock so cooperating Dalam mutations do

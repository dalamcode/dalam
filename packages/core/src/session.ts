...
import { ListAnchor } from "@uthakkan/schema/session"
...
import { SessionDurable } from "@uthakkan/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@dalam/v2/Session") {}

...
import type { Data, Definition, Payload } from "@uthakkan/schema/event"
...
import { Durable } from "@uthakkan/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@uthakkan/schema/event").ID
export type { Data, Definition, Payload } from "@uthakkan/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@dalam/Event") {}

...
export class Service extends Context.Service<Service, Interface>()("@dalam/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.DALAM_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))

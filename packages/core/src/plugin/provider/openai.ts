...
import type { IntegrationOAuthMethodRegistration } from "@uthakkan/plugin/v2/effect/integration"
import { define } from "@uthakkan/plugin/v2/effect/plugin"
...
function headers(contentType: string) {
  return { "Content-Type": contentType, "User-Agent": `dalam/${InstallationVersion}` }
}

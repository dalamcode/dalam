...
import { Entry, FileSystem, FindInput, Match } from "@uthakkan/schema/filesystem"
export { Entry, Match, Submatch } from "@uthakkan/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@dalam/v2/FileSystem") {}

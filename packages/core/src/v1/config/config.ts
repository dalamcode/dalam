...
export const Info = Schema.Struct({
  ...
  server: Schema.optional(ConfigServerV1.Server).annotate({
    description: "Server configuration for dalam serve and web commands",
  }),
  command: Schema.optional(Schema.Record(Schema.String, ConfigCommandV1.Info)).annotate({
    description: "Command configuration, see https://dalam.uthakkan.in/docs/commands",
  }),
  ...
  ).annotate({ description: "Agent configuration, see https://dalam.uthakkan.in/docs/agents" }),

...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@uthakkan/llm"
...
export class Service extends Context.Service<Service, Interface>()("@dalam/v2/ToolRegistry") {}

...
import type { EffectDrizzleSqlite } from "@uthakkan/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@dalam/ProjectDirectories") {}

...
import { Event } from "@uthakkan/schema/project-directories"
import { ProjectCopy } from "@uthakkan/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@dalam/ProjectCopy") {}

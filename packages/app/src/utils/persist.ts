...
const GLOBAL_STORAGE = "dalam.global.dat"
const WINDOW_STORAGE = "dalam.window"
const LOCAL_PREFIX = "dalam."
...
function workspaceStorage(dir: string) {
  ...
  return `dalam.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `dalam.draft.${head}.${sum}.dat`
}

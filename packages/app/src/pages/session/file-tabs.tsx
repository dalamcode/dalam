...
import type { FileSearchHandle } from "@uthakkan/session-ui/file"
import { useFileComponent } from "@uthakkan/ui/context/file"
import { cloneSelectedLineRange, previewSelectedLines } from "@uthakkan/session-ui/pierre/selection-bridge"
import { createLineCommentController } from "@uthakkan/session-ui/line-comment-annotations"
import { createLineCommentControllerV2 } from "@uthakkan/session-ui/v2/line-comment-annotations-v2"
import { sampledChecksum } from "@uthakkan/core/util/encode"
import { DropdownMenu } from "@uthakkan/ui/dropdown-menu"
import { IconButton } from "@uthakkan/ui/icon-button"
import { LineCommentV2OverflowIcon } from "@uthakkan/ui/v2/line-comment-v2"
import { MenuV2 } from "@uthakkan/ui/v2/menu-v2"
import { Tabs } from "@uthakkan/ui/tabs"
import { ScrollView } from "@uthakkan/ui/scroll-view"
  ...
  const renderFile = (source: string) => (
    <div class="relative overflow-hidden pb-40">
      <Dynamic
        ...
        search={search}
        class="select-text [--dalam-diffs-bg:var(--v2-background-bg-base)]"
        media={{
          mode: "auto",
          path: path(),
          current: state()?.content,

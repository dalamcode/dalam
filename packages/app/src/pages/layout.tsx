...
import { Session } from "@uthakkan/sdk/v2/client"
...
import { toaster } from "@uthakkan/ui/toast"
...
import { useTheme, type ColorScheme } from "@uthakkan/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://github.com/dalamcode/dalam/issues")}
      renderPanel={() =>

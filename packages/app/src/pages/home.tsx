...
import { ProjectAvatar } from "@uthakkan/ui/v2/project-avatar-v2"
...
import { useMarked } from "@uthakkan/ui/context/marked"
import { preloadMarkdown } from "@uthakkan/session-ui/markdown-cache"
      ...
      >
        <div class="mx-auto grid min-h-full w-full max-w-[1080px] grid-rows-[auto_minmax(0,1fr)_auto] gap-4 px-3 lg:grid-cols-[280px_minmax(0,720px)] lg:grid-rows-1 lg:gap-8 lg:px-6">
          <HomeProjectColumn
            ...
            openHelp={() => platform.openLink("https://github.com/dalamcode/dalam/issues")}
            language={language}
            onWheel={(event) => {

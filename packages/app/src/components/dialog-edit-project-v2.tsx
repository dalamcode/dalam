...
import { Field } from "@uthakkan/ui/v2/field-v2"
import { Icon } from "@uthakkan/ui/v2/icon"
import { ProjectAvatar, PROJECT_AVATAR_VARIANTS } from "@uthakkan/ui/v2/project-avatar-v2"
import { TextareaV2 } from "@uthakkan/ui/v2/textarea-v2"
import { TextInputV2 } from "@uthakkan/ui/v2/text-input-v2"
  ...
  return (
    <Dialog fit>
      <form onSubmit={model.submit} class="contents">
        ...
        <DialogFooter>
          <ButtonV2 type="button" variant="neutral" disabled={model.save.isPending} onClick={() => { void model.close() }}>

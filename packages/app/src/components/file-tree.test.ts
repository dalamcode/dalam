...
beforeAll(async () => {
  ...
  mock.module("@uthakkan/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@uthakkan/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@uthakkan/ui/icon", () => ({ Icon: () => null }))
  mock.module("@uthakkan/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

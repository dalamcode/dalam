...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Dalam.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Dalam.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Dalam.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i dalam.json",
  ...
  "dialog.server.description": "Bytt hvilken Dalam-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Dalam ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Dalam-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (dalam.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Dalam ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Dalam inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Dalam-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Dalam",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Dalam ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Dalam skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Dalam er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Dalam starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Dalam.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Dalam...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Dalam i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Dalam...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Dalam i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Dalam i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Dalam",
  ...
  "wsl.onboarding.distroStatus.dalamMissing": "Dalam er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Dalam kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Dalam kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Dalam på nytt.",

export const dict = {
  ...
  "wsl.onboarding.checkingDalam": "Dalam 확인 중...",
  "wsl.onboarding.checkingDalamIn": "{{distro}}에서 Dalam 확인 중...",
  "wsl.onboarding.updatingDalam": "Dalam 업데이트 중...",
  "wsl.onboarding.updatingDalamIn": "{{distro}}에서 Dalam 업데이트 중...",
  "wsl.onboarding.updateDalamIn": "{{distro}}에서 Dalam를 업데이트하세요.",
  "wsl.onboarding.updateDalam": "Dalam 업데이트",
  "wsl.onboarding.dalamReadyIn": "{{distro}}에서 Dalam를 사용할 준비가 되었습니다.",
  "wsl.onboarding.dalamReady": "Dalam가 준비되었습니다.",
  "wsl.onboarding.installDalamIn": "{{distro}}에 Dalam를 설치하세요.",
  "wsl.onboarding.installDalam": "Dalam 설치",

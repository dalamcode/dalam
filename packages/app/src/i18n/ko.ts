export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Dalam에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 Dalam에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 Dalam에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 Dalam에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.plugins.empty": "dalam.json에 구성된 플러그인",
  ...
  "dialog.server.description": "이 앱이 연결할 Dalam 서버를 전환합니다.",
  ...
  "toast.update.description": "Dalam의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 Dalam 팀에 제보해 주세요: ",
  ...
  "error.chain.checkConfig": "구성(dalam.json)의 공급자/모델 이름을 확인하세요",
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: Dalam는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "Dalam에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 Dalam 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "Dalam 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 Dalam가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "Dalam가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "Dalam 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "Dalam를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 Dalam를 사용 중입니다.",
  ...
  "wsl.onboarding.checkingOpencode": "Dalam 확인 중...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}에서 Dalam 확인 중...",
  "wsl.onboarding.updatingOpencode": "Dalam 업데이트 중...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}에서 Dalam 업데이트 중...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}에서 Dalam를 업데이트하세요.",
  "wsl.onboarding.updateOpencode": "Dalam 업데이트",
  "wsl.onboarding.dalamReadyIn": "{{distro}}에서 Dalam를 사용할 준비가 되었습니다.",
  "wsl.onboarding.dalamReady": "Dalam가 준비되었습니다.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}에 Dalam를 설치하세요.",
  "wsl.onboarding.installOpencode": "Dalam 설치",
  ...
  "wsl.onboarding.distroStatus.dalamMissing": "Dalam가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Dalam에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "Dalam에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 Dalam를 다시 여세요.",

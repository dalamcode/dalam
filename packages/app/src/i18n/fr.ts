export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Dalam",
  "dialog.model.unpaid.addMore.title": "Ajouter plus de modèles de fournisseurs populaires",
  "dialog.model.unpaid.viewMoreProviders": "Voir 70+ fournisseurs supplémentaires",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Dalam.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Dalam.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Dalam.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans dalam.json",
  ...
  "dialog.server.description": "Changez le serveur Dalam auquel cette application se connecte.",
  ...
  "wsl.onboarding.step.dalam": "Dalam",
  ...
  "wsl.onboarding.checkingDalam": "Vérification d'Dalam...",
  "wsl.onboarding.checkingDalamIn": "Vérification d'Dalam dans {{distro}}...",
  "wsl.onboarding.updatingDalam": "Mise à jour d'Dalam...",
  "wsl.onboarding.updatingDalamIn": "Mise à jour d'Dalam dans {{distro}}...",
  "wsl.onboarding.updateDalamIn": "Mettez à jour Dalam dans {{distro}}.",
  "wsl.onboarding.updateDalam": "Mettre à jour Dalam",
  "wsl.onboarding.dalamReadyIn": "Dalam est prêt dans {{distro}}.",
  "wsl.onboarding.dalamReady": "Dalam est prêt.",
  "wsl.onboarding.installDalamIn": "Installez Dalam dans {{distro}}.",
  "wsl.onboarding.installDalam": "Installer Dalam",
  ...
  "wsl.onboarding.distroStatus.dalamMissing": "Dalam non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Dalam puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Dalam n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Dalam.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Dalam ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Dalam",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (dalam.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Dalam ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Dalam inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "Dalam Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Dalam dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Dalam",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Dalam sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Dalam suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Dalam.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Dalam",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Dalam.",

export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Dalam...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Dalam dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Dalam...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Dalam dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Dalam dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Dalam",
  "wsl.onboarding.dalamReadyIn": "Dalam est prêt dans {{distro}}.",
  "wsl.onboarding.dalamReady": "Dalam est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Dalam dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Dalam",

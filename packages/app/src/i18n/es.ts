export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Dalam",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Dalam.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Dalam.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Dalam.",
  ...
  "dialog.plugins.empty": "Plugins configurados en dalam.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Dalam se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Dalam...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Dalam en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Dalam...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Dalam en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Dalam en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Dalam",
  "wsl.onboarding.dalamReadyIn": "Dalam está listo en {{distro}}.",
  "wsl.onboarding.dalamReady": "Dalam está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Dalam en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Dalam",
  ...
  "wsl.onboarding.distroStatus.dalamMissing": "Dalam no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Dalam pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Dalam no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Dalam.",
  ...
  "toast.update.description": "Una nueva versión de Dalam ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Dalam",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (dalam.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Dalam no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Dalam incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Dalam dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Dalam",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Dalam en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Dalam sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Dalam.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Dalam",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Dalam.",

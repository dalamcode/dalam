export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Dalam-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Dalam-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Dalam-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u dalam.json",
  ...
  "dialog.server.description": "Promijeni na koji se Dalam server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Dalam...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Dalam u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Dalam...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Dalam u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Dalam u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Dalam",
  "wsl.onboarding.dalamReadyIn": "Dalam je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.dalamReady": "Dalam je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Dalam u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Dalam",
  ...
  "wsl.onboarding.distroStatus.dalamMissing": "Dalam nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Dalam mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Dalam nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Dalam.",
  ...
  "toast.update.description": "Nova verzija Dalam-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Dalam timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (dalam.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Dalam još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Dalam uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Dalam server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Dalam-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Dalam izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Dalam prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Dalam-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Dalam pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Dalam-a.",

...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Dalam 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Dalam 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Dalam 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 dalam.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Dalam 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Dalam...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Dalam...",
  ...
  "wsl.onboarding.dalamReadyIn": "{{distro}} 中的 Dalam 已就緒。",
  "wsl.onboarding.dalamReady": "Dalam 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Dalam。",
  "wsl.onboarding.installOpencode": "安裝 Dalam",
  ...
  "wsl.onboarding.distroStatus.dalamMissing": "未安裝 Dalam",
  ...
  "wsl.onboarding.wslUnavailable.description": "Dalam 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Dalam。",
  ...
  "toast.update.description": "Dalam 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Dalam 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (dalam.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Dalam 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Dalam 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Dalam 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Dalam 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Dalam 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Dalam 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Dalam 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Dalam 啟動時自動檢查更新",

export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Dalam",
  "dialog.model.unpaid.addMore.title": "เพิ่มโมเดลเพิ่มเติมจากผู้ให้บริการยอดนิยม",
  "dialog.model.unpaid.viewMoreProviders": "ดูผู้ให้บริการ 70+ รายเพิ่มเติม",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Dalam",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Dalam",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Dalam",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน dalam.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Dalam ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingDalam": "กำลังตรวจสอบ Dalam...",
  "wsl.onboarding.checkingDalamIn": "กำลังตรวจสอบ Dalam ใน {{distro}}...",
  "wsl.onboarding.updatingDalam": "กำลังอัปเดต Dalam...",
  "wsl.onboarding.updatingDalamIn": "กำลังอัปเดต Dalam ใน {{distro}}...",
  "wsl.onboarding.updateDalamIn": "อัปเดต Dalam ใน {{distro}}.",
  "wsl.onboarding.updateDalam": "อัปเดต Dalam",
  "wsl.onboarding.dalamReadyIn": "Dalam พร้อมใช้งานใน {{distro}} แล้ว.",
  "wsl.onboarding.dalamReady": "Dalam พร้อมใช้งานแล้ว.",
  "wsl.onboarding.installDalamIn": "ติดตั้ง Dalam ใน {{distro}}.",
  "wsl.onboarding.installDalam": "ติดตั้ง Dalam",
  ...
  "wsl.onboarding.distroStatus.dalamMissing": "ยังไม่ได้ติดตั้ง Dalam",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ Dalam จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "Dalam ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้.",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด Dalam อีกครั้ง.",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Dalam ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Dalam",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (dalam.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Dalam ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "session.header.reveal.containingFolder": "เปิดโฟลเดอร์ที่มี",
  ...
  "sidebar.gettingStarted.line1": "Dalam รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Dalam ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Dalam",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ Dalam มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Dalam ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ Dalam มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Dalam เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Dalam เวอร์ชันล่าสุด",

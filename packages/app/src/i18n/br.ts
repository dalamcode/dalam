export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Dalam",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Dalam.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Dalam.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Dalam.",
  ...
  "dialog.plugins.empty": "Plugins configurados em dalam.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Dalam este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingDalam": "Verificando o Dalam...",
  "wsl.onboarding.checkingDalamIn": "Verificando o Dalam em {{distro}}...",
  "wsl.onboarding.updatingDalam": "Atualizando o Dalam...",
  "wsl.onboarding.updatingDalamIn": "Atualizando o Dalam em {{distro}}...",
  "wsl.onboarding.updateDalamIn": "Atualize o Dalam em {{distro}}.",
  "wsl.onboarding.updateDalam": "Atualizar o Dalam",
  "wsl.onboarding.dalamReadyIn": "O Dalam está pronto em {{distro}}.",
  "wsl.onboarding.dalamReady": "O Dalam está pronto.",
  "wsl.onboarding.installDalamIn": "Instale o Dalam em {{distro}}.",
  "wsl.onboarding.installDalam": "Instalar o Dalam",
  ...
  "wsl.onboarding.distroStatus.dalamMissing": "Dalam não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Dalam possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Dalam não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Dalam novamente.",
  ...
  "toast.update.description": "Uma nova versão do Dalam ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Dalam",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (dalam.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Dalam ainda não suporta autenticação MCP.',
  ...
  "session.header.reveal.containingFolder": "Abrir pasta contendo",
  ...
  "sidebar.gettingStarted.line1": "Dalam inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Dalam dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Dalam",
  ...
  "settings.general.row.appearance.description": "Personalize como o Dalam aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Dalam segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Dalam é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Dalam iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Dalam.",

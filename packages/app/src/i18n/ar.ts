export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Dalam",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Dalam.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Dalam.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Dalam.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في dalam.json",
  ...
  "dialog.server.description": "تبديل خادم Dalam الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Dalam...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Dalam في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Dalam...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Dalam في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Dalam في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Dalam",
  "wsl.onboarding.dalamReadyIn": "Dalam جاهز في {{distro}}.",
  "wsl.onboarding.dalamReady": "Dalam جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Dalam في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Dalam",
  ...
  "wsl.onboarding.distroStatus.dalamMissing": "Dalam غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Dalam من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Dalam التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Dalam.",
  ...
  "toast.update.description": "نسخة جديدة من Dalam ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Dalam",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (dalam.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Dalam لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Dalam نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Dalam داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Dalam",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Dalam على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Dalam يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Dalam.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Dalam",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Dalam.",

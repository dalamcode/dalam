export const dict = {
  ...
  "wsl.onboarding.checkingDalam": "جارٍ التحقق من Dalam...",
  "wsl.onboarding.checkingDalamIn": "جارٍ التحقق من Dalam في {{distro}}...",
  "wsl.onboarding.updatingDalam": "جارٍ تحديث Dalam...",
  "wsl.onboarding.updatingDalamIn": "جارٍ تحديث Dalam في {{distro}}...",
  "wsl.onboarding.updateDalamIn": "حدّث Dalam في {{distro}}.",
  "wsl.onboarding.updateDalam": "تحديث Dalam",
  "wsl.onboarding.dalamReadyIn": "Dalam جاهز في {{distro}}.",
  "wsl.onboarding.dalamReady": "Dalam جاهز.",
  "wsl.onboarding.installDalamIn": "ثبّت Dalam في {{distro}}.",
  "wsl.onboarding.installDalam": "تثبيت Dalam",

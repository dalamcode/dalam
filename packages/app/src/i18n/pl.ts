export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Dalam",
  "dialog.model.unpaid.addMore.title": "Dodaj więcej modeli od popularnych dostawców",
  "dialog.model.unpaid.viewMoreProviders": "Zobacz 70+ więcej dostawców",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Dalam.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Dalam.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Dalam.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w dalam.json",
  ...
  "dialog.server.description": "Przełącz serwer Dalam, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingDalam": "Sprawdzanie Dalam...",
  "wsl.onboarding.checkingDalamIn": "Sprawdzanie Dalam w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingDalam": "Aktualizowanie Dalam...",
  "wsl.onboarding.updatingDalamIn": "Aktualizowanie Dalam w dystrybucji {{distro}}...",
  "wsl.onboarding.updateDalamIn": "Zaktualizuj Dalam w dystrybucji {{distro}}.",
  "wsl.onboarding.updateDalam": "Zaktualizuj Dalam",
  "wsl.onboarding.dalamReadyIn": "Dalam jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.dalamReady": "Dalam jest gotowy.",
  "wsl.onboarding.installDalamIn": "Zainstaluj Dalam w dystrybucji {{distro}}.",
  "wsl.onboarding.installDalam": "Zainstaluj Dalam",
  ...
  "wsl.onboarding.distroStatus.dalamMissing": "Dalam nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Dalam będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Dalam nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Dalam.",
  ...
  "toast.update.description": "Nowa wersja Dalam ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Dalam",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (dalam.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Dalam nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "session.header.reveal.containingFolder": "Otwórz zawierający folder",
  ...
  "sidebar.gettingStarted.line1": "Dalam zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Dalam wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Dalam",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Dalam na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Dalam ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Dalam.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Dalam",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Dalam.",

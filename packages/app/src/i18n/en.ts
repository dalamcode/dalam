export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Dalam",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Dalam.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Dalam.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Dalam.",
  ...
  "dialog.plugins.empty": "Plugins configured in dalam.json",
  ...
  "dialog.server.description": "Switch which Dalam server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Dalam...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Dalam in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Dalam...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Dalam in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Dalam in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Dalam",
  "wsl.onboarding.dalamReadyIn": "Dalam is ready in {{distro}}.",
  "wsl.onboarding.dalamReady": "Dalam is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Dalam in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Dalam",
  ...
  "wsl.onboarding.distroStatus.dalamMissing": "Dalam not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Dalam can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Dalam could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Dalam.",
  ...
  "toast.update.description": "A new version of Dalam ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Dalam team",
  ...
  "error.chain.checkConfig": "Check your config (dalam.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Dalam does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Dalam includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for Dalam",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Dalam looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Dalam follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Dalam is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Dalam launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Dalam.",

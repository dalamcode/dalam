...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Dalam 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Dalam 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Dalam 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 dalam.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Dalam 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 Dalam...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 Dalam...",
  "wsl.onboarding.updatingOpencode": "正在更新 Dalam...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 Dalam...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 Dalam。",
  "wsl.onboarding.updateOpencode": "更新 Dalam",
  "wsl.onboarding.dalamReadyIn": "{{distro}} 中的 Dalam 已就绪。",
  "wsl.onboarding.dalamReady": "Dalam 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 Dalam。",
  "wsl.onboarding.installOpencode": "安装 Dalam",
  ...
  "wsl.onboarding.distroStatus.dalamMissing": "未安装 Dalam",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Dalam 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Dalam 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Dalam。",
  ...
  "toast.update.description": "Dalam 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Dalam 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (dalam.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Dalam 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Dalam 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Dalam 服务器。",
  ...
  "settings.general.row.language.description": "更改 Dalam 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Dalam 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Dalam 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Dalam 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Dalam 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Dalam。",

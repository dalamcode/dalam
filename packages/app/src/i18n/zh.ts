...
export const dict = {
  ...
  "wsl.onboarding.checkingDalam": "正在检查 Dalam...",
  "wsl.onboarding.checkingDalamIn": "正在检查 {{distro}} 中的 Dalam...",
  "wsl.onboarding.updatingDalam": "正在更新 Dalam...",
  "wsl.onboarding.updatingDalamIn": "正在更新 {{distro}} 中的 Dalam...",
  "wsl.onboarding.updateDalamIn": "更新 {{distro}} 中的 Dalam。",
  "wsl.onboarding.updateDalam": "更新 Dalam",
  "wsl.onboarding.dalamReadyIn": "{{distro}} 中的 Dalam 已就绪。",
  "wsl.onboarding.dalamReady": "Dalam 已就绪。",
  "wsl.onboarding.installDalamIn": "在 {{distro}} 中安装 Dalam。",
  "wsl.onboarding.installDalam": "安装 Dalam",

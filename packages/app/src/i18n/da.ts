export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Dalam",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Dalam.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Dalam.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Dalam.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i dalam.json",
  ...
  "dialog.server.description": "Skift hvilken Dalam-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Dalam...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Dalam i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Dalam...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Dalam i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Dalam i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Dalam",
  "wsl.onboarding.dalamReadyIn": "Dalam er klar i {{distro}}.",
  "wsl.onboarding.dalamReady": "Dalam er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Dalam i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.dalamMissing": "Dalam er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Dalam kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Dalam kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Dalam igen.",
  ...
  "toast.update.description": "En ny version af Dalam ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Dalam-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (dalam.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Dalam understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Dalam inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Dalam-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Dalam",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Dalam ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Dalam følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Dalam er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Dalam starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Dalam.",

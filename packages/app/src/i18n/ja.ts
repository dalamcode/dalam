export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Dalamが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Dalamで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してDalamで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Dalamで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "dalam.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するDalamサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingDalam": "Dalamを確認中...",
  "wsl.onboarding.checkingDalamIn": "{{distro}}内のDalamを確認中...",
  "wsl.onboarding.updatingDalam": "Dalamを更新中...",
  "wsl.onboarding.updatingDalamIn": "{{distro}}内のDalamを更新中...",
  "wsl.onboarding.updateDalamIn": "{{distro}}内のDalamを更新してください。",
  "wsl.onboarding.updateDalam": "Dalamを更新",
  "wsl.onboarding.dalamReadyIn": "{{distro}}内のDalamの準備ができました。",
  "wsl.onboarding.dalamReady": "Dalamの準備ができました。",
  "wsl.onboarding.installDalamIn": "{{distro}}にDalamをインストールしてください。",
  "wsl.onboarding.installDalam": "Dalamをインストール",
  ...
  "wsl.onboarding.distroStatus.dalamMissing": "Dalamがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "DalamでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Dalamをもう一度開いてください。",
  ...
  "toast.update.description": "Dalamの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをDalamチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (dalam.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: DalamはまだMCP認証をサポートしていません。',
  ...
  "session.header.reveal.containingFolder": "フォルダを開く",
  ...
  "sidebar.gettingStarted.line1": "Dalamには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でDalamサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Dalamの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのDalamの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Dalamがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Dalamのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Dalam の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Dalam は最新バージョンです。",

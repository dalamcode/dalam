export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "Dalamを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のDalamを確認中...",
  "wsl.onboarding.updatingOpencode": "Dalamを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のDalamを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のDalamを更新してください。",
  "wsl.onboarding.updateOpencode": "Dalamを更新",
  "wsl.onboarding.dalamReadyIn": "{{distro}}内のDalamの準備ができました。",
  "wsl.onboarding.dalamReady": "Dalamの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にDalamをインストールしてください。",
  "wsl.onboarding.installOpencode": "Dalamをインストール",

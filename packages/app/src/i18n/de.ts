...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Dalam",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Dalam zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Dalam zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Dalam zu nutzen.",
  ...
  "dialog.plugins.empty": "In dalam.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Dalam-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Dalam wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "Dalam in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "Dalam wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "Dalam in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Dalam in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dalam aktualisieren",
  "wsl.onboarding.dalamReadyIn": "Dalam ist in {{distro}} bereit.",
  "wsl.onboarding.dalamReady": "Dalam ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Dalam in {{distro}}.",
  "wsl.onboarding.installOpencode": "Dalam installieren",
  ...
  "wsl.onboarding.distroStatus.dalamMissing": "Dalam nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Dalam einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Dalam konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Dalam erneut.",
  ...
  "toast.update.description": "Eine neue Version von Dalam ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Dalam-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (dalam.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Dalam unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Dalam enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Dalam-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Dalam ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Dalam auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Dalam dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Dalam anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Dalam automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Dalam.",

...
export const dict = {
  ...
  "wsl.onboarding.checkingDalam": "Dalam kontrol ediliyor...",
  "wsl.onboarding.checkingDalamIn": "{{distro}} içinde Dalam kontrol ediliyor...",
  "wsl.onboarding.updatingDalam": "Dalam güncelleniyor...",
  "wsl.onboarding.updatingDalamIn": "{{distro}} içinde Dalam güncelleniyor...",
  "wsl.onboarding.updateDalamIn": "{{distro}} içindeki Dalam'u güncelleyin.",
  "wsl.onboarding.updateDalam": "Dalam'u güncelle",
  "wsl.onboarding.dalamReadyIn": "{{distro}} içinde Dalam hazır.",
  "wsl.onboarding.dalamReady": "Dalam hazır.",
  "wsl.onboarding.installDalamIn": "Dalam'u {{distro}} içine kurun.",
  "wsl.onboarding.installDalam": "Dalam'u kur",

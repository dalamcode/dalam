...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Dalam'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Dalam'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Dalam'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler dalam.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Dalam sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Dalam kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Dalam kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Dalam güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Dalam güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Dalam'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Dalam'u güncelle",
  "wsl.onboarding.dalamReadyIn": "{{distro}} içinde Dalam hazır.",
  "wsl.onboarding.dalamReady": "Dalam hazır.",
  "wsl.onboarding.installOpencodeIn": "Dalam'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Dalam'u kur",
  ...
  "wsl.onboarding.distroStatus.dalamMissing": "Dalam kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Dalam'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Dalam bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Dalam'u tekrar açın.",
  ...
  "toast.update.description": "Dalam'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Dalam ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (dalam.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Dalam henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Dalam ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Dalam Masaüstü",
  ...
  "settings.desktop.wsl.description": "Dalam sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Dalam'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Dalam'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Dalam'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Dalam'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Dalam başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Dalam'un en son sürümünü kullanıyorsunuz.",

export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Dalam",
  "dialog.model.unpaid.addMore.title": "Добавьте больше моделей от популярных провайдеров",
  "dialog.model.unpaid.viewMoreProviders": "Посмотреть 70+ провайдеров",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Dalam.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Dalam.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Dalam.",
  ...
  "dialog.plugins.empty": "Плагины настроены в dalam.json",
  ...
  "dialog.server.description": "Переключите сервер Dalam к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingDalam": "Проверка Dalam...",
  "wsl.onboarding.checkingDalamIn": "Проверка Dalam в {{distro}}...",
  "wsl.onboarding.updatingDalam": "Обновление Dalam...",
  "wsl.onboarding.updatingDalamIn": "Обновление Dalam в {{distro}}...",
  "wsl.onboarding.updateDalamIn": "Обновите Dalam в {{distro}}.",
  "wsl.onboarding.updateDalam": "Обновить Dalam",
  "wsl.onboarding.dalamReadyIn": "Dalam в {{distro}} готов к работе.",
  "wsl.onboarding.dalamReady": "Dalam готов к работе.",
  "wsl.onboarding.installDalamIn": "Установите Dalam в {{distro}}.",
  "wsl.onboarding.installDalam": "Установить Dalam",
  ...
  "wsl.onboarding.distroStatus.dalamMissing": "Dalam не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Dalam требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Dalam не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте Dalam.",
  ...
  "toast.update.description": "Новая версия Dalam ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Dalam",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (dalam.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Dalam пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Dalam включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Dalam внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Dalam",
  ...
  "settings.general.row.appearance.description": "Настройте как Dalam выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Dalam системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Dalam.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Dalam",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Dalam.",

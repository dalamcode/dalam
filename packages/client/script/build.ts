...
import { compile, emitEffectImported, emitPromise, write } from "@uthakkan/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "DalamEventEncoded",
              import: 'import type { DalamEventEncoded } from "@uthakkan/protocol/groups/event"',
            },
          },
        }),

...
const releaseId = process.env.DALAM_RELEASE
if (!releaseId) throw new Error("DALAM_RELEASE is required")

const version = process.env.DALAM_VERSION
if (!version) throw new Error("DALAM_VERSION is required")
...
const macxTarGz = "dalam-desktop-mac-x64.app.tar.gz"
const macaTarGz = "dalam-desktop-mac-arm64.app.tar.gz"

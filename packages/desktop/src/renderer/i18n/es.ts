export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Dalam",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Dalam. ¿Quieres instalarla y reiniciar?",

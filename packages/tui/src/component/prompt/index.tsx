...
import { registerDalamSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@uthakkan/sdk/v2"
...
import { DALAM_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useDalamKeymap } from "../../keymap"
...
export function Prompt(props: PromptProps) {
  ...
  // oxlint-disable-next-line typescript-eslint/unbound-method -- project property access is intentional
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.DALAM_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },

...
import defaultSoundPath from "@uthakkan/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@uthakkan/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@uthakkan/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@uthakkan/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@uthakkan/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@uthakkan/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "dalam"
const DEFAULT_PACK_ID = "dalam.default"

...
export const {
  context: SyncContext,
  // oxlint-disable-next-line typescript-eslint/unbound-method -- arrow function returned by createSimpleContext
  use: useSync,
  ...
  init: () => {
    ...
    async function bootstrap(input: { fatal?: boolean } = {}) {
      ...
      const capabilitiesPromise = sdk.client.experimental.capabilities
        ...
        .then((x) => x.data)
        .catch(() => undefined)
      const consoleStatePromise = Promise.resolve(emptyConsoleState)

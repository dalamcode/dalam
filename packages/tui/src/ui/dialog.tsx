...
import { useBindings, useDalamModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useDalamModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.DALAM_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >

import type { TuiPlugin, TuiPluginApi } from "@uthakkan/plugin/tui"
...
function View(props: { api: TuiPluginApi; sessionID: string }) {
  ...
  const has = createMemo(() =>
    props.api.state.provider.some((item) =>
      ...
      <Show when={show()}>
        ...
        >
          ...
          <box flexGrow={1} gap={1}>
            ...
            <text fg={theme().textMuted}>Dalam includes free models so you can start immediately.</text>

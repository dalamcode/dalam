...
const tools: readonly ToolFixture[] = [
  ...
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/dalam (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/dalam/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/dalam/src/index.ts [offset=1, limit=100]",

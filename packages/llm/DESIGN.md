...
> current private `@uthakkan-dalam/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@uthakkan-dalam/ai`
...
- Secondary audience: Dalam and other durable agent runtimes
...
import { LLM } from "@uthakkan-dalam/ai"
import { OpenAI } from "@uthakkan-dalam/ai/providers/openai"
...
```ts
import { Message } from "@uthakkan-dalam/ai"
...
import { LLM, Tool } from "@uthakkan-dalam/ai"
...
Dalam and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@uthakkan-dalam/ai/promise"
import { OpenAI } from "@uthakkan-dalam/ai/providers/openai"
...
```ts
import { LLMSchema } from "@uthakkan-dalam/ai/schema"
...
```ts
import { Provider, Protocol } from "@uthakkan-dalam/ai/provider"
...
@uthakkan-dalam/ai/promise
  Promise/AsyncIterable LLM facade

@uthakkan-dalam/ai/schema
  serializable domain schemas

@uthakkan-dalam/ai/provider
  experimental Provider and Protocol authoring APIs

@uthakkan-dalam/ai/providers/openai
@uthakkan-dalam/ai/providers/anthropic
@uthakkan-dalam/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@uthakkan-dalam/llm`                      | `@uthakkan-dalam/ai`                                           |
...
Dalam should migrate to `generateTurn` / `streamTurn`, preserving its durable

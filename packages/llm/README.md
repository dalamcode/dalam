...
Schema-first LLM core for dalam. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@uthakkan-dalam/llm"
import { OpenAI } from "@uthakkan-dalam/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@uthakkan-dalam/llm/providers"

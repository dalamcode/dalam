...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips dalam-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-dalam-directory"]).toBeUndefined()
      expect(forwarded["x-dalam-workspace"]).toBeUndefined()

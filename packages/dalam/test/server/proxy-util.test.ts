...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips dalam-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-dalam-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-dalam-directory")).toBeNull()
      expect(result.get("x-dalam-workspace")).toBeNull()

...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders DALAM_CALLER", () => {
    process.env["DALAM_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode DALAM_CALLER", () => {
    process.env["DALAM_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown DALAM_CALLER", () => {
    process.env["DALAM_CALLER"] = "unknown"

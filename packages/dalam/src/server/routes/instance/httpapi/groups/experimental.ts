      ...
      .add(
        HttpApiEndpoint.get("capabilities", ExperimentalPaths.capabilities, {
          ...
          OpenApi.annotations({
            ...
            description: "Get experimental features enabled on the Dalam server.",
          }),
        ),
        ...
        HttpApiEndpoint.get("session", ExperimentalPaths.session, {
          ...
          OpenApi.annotations({
            ...
            description:
              "Get a list of all Dalam sessions across projects, sorted by most recently updated. Archived sessions are excluded by default.",
          }),
        ),

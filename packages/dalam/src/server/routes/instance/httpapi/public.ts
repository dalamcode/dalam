...
const LegacyComponentDescriptions: Record<string, string> = {
  LogLevel: "Log level",
  ServerConfig: "Server configuration for dalam serve and web commands",
...
function fixSelfReferencingComponents(spec: OpenApiSpec) {
  ...
  const raw: OpenApiSpec = OpenApi.fromApi(DalamHttpApi)
...
export const PublicApi = DalamHttpApi.annotateMerge(
  OpenApi.annotations({
    title: "dalam",
    version: "1.0.0",
    description: "dalam api",

...
import { MoveSession } from "@uthakkan/core/control-plane/move-session"
...
import { ProjectCopy } from "@uthakkan/core/project/copy"
...
import { CorsConfig, isAllowedCorsOrigin, type CorsOptions } from "@uthakkan/server/cors"
...
import { handlers } from "@uthakkan/server/handlers"
import { buildLocationServiceMap, LocationServiceMap } from "@uthakkan/core/location-services"
import { layer as locationLayer } from "@uthakkan/server/location"
import { sessionLocationLayer } from "@uthakkan/server/middleware/session-location"
import { PtyEnvironment } from "@uthakkan/server/pty-environment"
import { schemaErrorLayer as v2SchemaErrorLayer } from "@uthakkan/server/middleware/schema-error"
...
const uiRoute = HttpRouter.use((router) =>
  Effect.gen(function* () {
    ...
    yield* router.add("*", "/*", (request) =>
      serveUIEffect(request, { fs, client: undefined, disableEmbeddedWebUi: flags.disableEmbeddedWebUi }),
    )
  }),

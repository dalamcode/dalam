...
>()("@dalam/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@dalam/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.DALAM_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.DALAM_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-dalam-directory"] || process.cwd()
}

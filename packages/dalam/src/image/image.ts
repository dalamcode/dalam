...
export class Service extends Context.Service<Service, Interface>()("@dalam/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __DALAM_PHOTON_WASM_PATH?: string }).__DALAM_PHOTON_WASM_PATH =

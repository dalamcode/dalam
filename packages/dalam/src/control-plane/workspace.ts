...
import { EventSequenceTable, EventTable } from "@uthakkan/core/event/sql"
...
import { WorkspaceEvent } from "@uthakkan/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@dalam/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        DALAM_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        DALAM_WORKSPACE_ID: config.id,
        DALAM_EXPERIMENTAL_WORKSPACES: "true",

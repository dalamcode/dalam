...
import { ConfigMCPV1 } from "@uthakkan/core/v1/config/mcp"
...
import { McpEvent } from "@uthakkan/schema/mcp-event"
import { McpBrowser } from "./browser"

const DEFAULT_TIMEOUT = 30_000
const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/dalamcode/dalam/issues/11948
    // sampling: {},
    // https://github.com/dalamcode/dalam/issues/23066
    // elicitation: {},
    // https://github.com/dalamcode/dalam/issues/2308
    roots: {},
    // https://github.com/dalamcode/dalam/issues/28567
    // tasks: {},
  },
...
function createClient(directory: string) {
  const client = new Client({ name: "dalam", version: InstallationVersion }, CLIENT_OPTIONS)
...
export class Service extends Context.Service<Service, Interface>()("@dalam/MCP") {}
            ...
            if (isAuthError) {
              if (lastError.message.includes("registration") || lastError.message.includes("client_id")) {
                ...
                return events
                  .publish(TuiEvent.ToastShow, {
                    title: "MCP Authentication Required",
                    message: `Server "${key}" requires authentication. Run: dalam mcp auth ${key}`,
                    variant: "warning",
                    duration: 8000,
                  })
                  .pipe(Effect.ignore, Effect.as(undefined))

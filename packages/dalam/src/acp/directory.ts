...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@dalam/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@dalam/ACPDirectory") {}

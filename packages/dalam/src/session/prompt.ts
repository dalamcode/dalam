...
import { MAX_STEPS_PROMPT } from "@uthakkan/core/session/runner/max-steps"
...
import { LLMEvent } from "@uthakkan/llm"
...
export class Service extends Context.Service<Service, Interface>()("@dalam/SessionPrompt") {}

import type { JsonSchema, LLMRequest, ProviderMetadata } from "@uthakkan/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@uthakkan/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @uthakkan/llm request objects from dalam's session/AI SDK-shaped data.
  return LLM.request({

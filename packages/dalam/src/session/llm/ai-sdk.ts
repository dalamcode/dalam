import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@uthakkan/llm"
...
// Move this extraction into @uthakkan/llm when Copilot is handled by the native runtime.

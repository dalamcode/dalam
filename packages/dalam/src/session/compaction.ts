...
import { buildPrompt } from "@uthakkan/core/session/compaction"
import { SessionCompactionEvent } from "@uthakkan/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@dalam/SessionCompaction") {}

...
import { PartTable, SessionTable } from "@uthakkan/core/session/sql"
...
import { NonNegativeInt, optional } from "@uthakkan/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".dalam", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@dalam/Session") {}

...
import type { Event, GlobalEvent, OpencodeClient } from "@uthakkan/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@dalam/RunStreamTransport") {}

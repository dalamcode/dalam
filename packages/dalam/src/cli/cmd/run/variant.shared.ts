...
//
// The saved variant persists across sessions in ~/.local/state/dalam/model.json
...
class Service extends Context.Service<Service, VariantService>()("@dalam/RunVariant") {}

...
import { openEditor } from "@uthakkan/tui/editor"
import { registerDalamKeymap } from "@uthakkan/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerDalamKeymap(keymap, renderer, input.tuiConfig)

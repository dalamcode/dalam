...
import { createOpencodeClient, type OpencodeClient, type ToolPart } from "@uthakkan/sdk/v2"
  ...
  builder: (yargs: Argv) =>
    yargs
      ...
      .option("username", {
        alias: ["u"],
        type: "string",
        describe: "basic auth username (defaults to OPENCODE_SERVER_USERNAME or 'dalam')",
      })
      .option("dir", {
        type: "string",

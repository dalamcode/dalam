import type { Session as SDKSession, Message, Part } from "@uthakkan/sdk/v2"
import { SessionV1 } from "@uthakkan/core/v1/session"
import { Session } from "@/session/session"
import { effectCmd } from "../effect-cmd"
import { Database } from "@uthakkan/core/database/database"
import { SessionTable, MessageTable, PartTable } from "@uthakkan/core/session/sql"
...
const runImport = Effect.fn("Cli.import.body")(function* (file: string, ctx: InstanceContext) {
  ...
  if (isUrl) {
    process.stdout.write(`URL import is no longer supported`)

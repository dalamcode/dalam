...
import { ProjectDirectoryTable, ProjectTable } from "@uthakkan/core/project/sql"
import { ProjectDirectories } from "@uthakkan/core/project/directories"
...
import { which } from "@uthakkan/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@dalam/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.DALAM_FAKE_VCS)

...
import { AbsolutePath, type DeepMutable } from "@uthakkan/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@dalam/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".dalam", "plans", "*.md")]: "allow",

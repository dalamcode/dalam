...
function installPackage(name) {
  ...
  const temp = fs.mkdtempSync(path.join(os.tmpdir(), "dalam-install-"))
  try {
...
function main() {
  ...
  throw new Error(
    `It seems your package manager failed to install the right dalam CLI package. Try manually installing ${packageNames()

...
Practical reference for the current tool-migration state in `packages/dalam`.
...
Tool tests should use the existing Effect helpers in `packages/dalam/test/lib/effect.ts`:
